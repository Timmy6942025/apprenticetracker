...
The scraper defaults to `tech`, `business`, and `data_analyst`.

- `TARGET_CATEGORIES`: Comma-separated subset of `tech,business,data_analyst`
...
```bash
TARGET_CATEGORIES=tech,business,data_analyst \
LINKEDIN_KEYWORDS="software apprentice,business apprentice,data analyst apprentice" \
